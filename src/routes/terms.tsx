...
export const Route = createFileRoute("/terms")({
  head: () => ({ meta: [{ title: "Terms — AtomSpot" }, { name: "description", content: "Terms of service." }] }),
  ...
  return (
    <div className="px-4 pt-28 pb-24 max-w-3xl mx-auto prose-invert">
      ...
      <div className="space-y-5 text-sm leading-relaxed text-muted-foreground">
        <p>By accessing AtomSpot ("the platform"), you agree to be bound by these terms. If you do not agree, do not use the platform.</p>
        ...
        <p><strong className="text-foreground">Sellers.</strong> Sellers warrant they have rights to list and sell their products and agree to AtomSpot's product policies.</p>
