  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {unread > 0 && (
          <span aria-hidden="true" className="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 rounded-full bg-aurora animate-aurora text-[10px] font-bold grid place-items-center text-background">
            {unread}
          </span>
        )}
      </button>
        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="fixed left-2 right-2 top-16 sm:absolute sm:left-auto sm:right-0 sm:top-auto sm:mt-2 sm:w-[360px] bg-background/95 backdrop-blur-2xl border border-white/10 shadow-elevated rounded-2xl z-50 overflow-hidden"
            >
